...
import dataloader_evaluate
from torch.autograd import Variable
from model import Gen_x_view_feature, Gen_view_feature_x
...
train_loader = torch.utils.data.DataLoader(
    dataloader_evaluate.ImageList( train_list, transform=transforms.Compose([
        transforms.ToTensor(),
